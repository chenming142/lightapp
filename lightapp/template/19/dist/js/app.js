define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./weixin", "./Lottery"], function(require, exports, module) {
    var $ = require("./zepto");
    $ = require("./touch");
    ...
    module.exports = {
        init_modle: function() {
            ...
            $.get(url, {}, function() {}), $(".p-ct").height($(window).height()), $(".m-page").height($(window).height()), $("#j-mengban").height($(window).height()), $(".translate-back").height($(window).height())
        }
    }
        ...
        r = {
            ...
            ajaxTongji: function(t) {
                ...
                var i = e("#activity_id").val(),
                    a = "/analyseplugin/plugin?activity_id=" + i + "&plugtype=" + t;
                e.get(a, {}, function() {})
            },
            wxShare: function() {
    ...
    var n = t("./Lottery"),
        ...
        r = {
            init: function() {
                ...
                var t = {};
                "" != e("#r-wx-title").val() && (t.title = e("#r-wx-title").val()), "" != e("#r-wx-img").val() && (t.img = e("#r-wx-img").val()), "" != e("#r-wx-con").val() && (t.con = e("#r-wx-con").val()), i._weixin && e(document.body).wx(t);
